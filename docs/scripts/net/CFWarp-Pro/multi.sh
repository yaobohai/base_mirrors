...
v66=`ping -6 ipv6.google.com -c 1 | grep received | awk 'NR==1 {print $4}'`
...
function upcore(){
wget -N --no-check-certificate http://mirrors.itan90.cn/CFWarp-Pro/upcore.sh&& chmod +x upcore.sh && ./upcore.sh
}
